...
3. **Clone Repository**: `git clone https://github.com/riteshdawale02/retail-store-microservices.git`
...
```sh
git clone https://github.com/riteshdawale02/retail-store-microservices.git
```
